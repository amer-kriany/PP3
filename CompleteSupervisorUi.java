 ...
 */
public class CompleteSupervisorUI extends JFrame {
    ...
    private void openTaskSearchAndFilter() {
        SwingUtilities.invokeLater(() -> {
            TaskSearchAndFilterUI gui = new TaskSearchAndFilterUI(manager);
            gui.setVisible(true);
        });
    }
    ...
    private void openProductionLinesByProduct() {
        SwingUtilities.invokeLater(() -> {
            ProductionLinesByProductUI gui = new ProductionLinesByProductUI(manager);
            gui.setVisible(true);
        });
    }
