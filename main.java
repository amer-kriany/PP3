...
public class Main {
    public static void main(String[] args) {
        ...
        Item cpu = new Item(1, "CPU", Item.Categories.TECHNOLOGY, 120.0, 1000, 10);
        Item ram = new Item(2, "RAM8", Item.Categories.TECHNOLOGY, 50.0, 1000, 10);
        Item ssd = new Item(3, "SSD128", Item.Categories.TECHNOLOGY, 80.0, 1000, 5);
        Item screen = new Item(4, "Screen", Item.Categories.TECHNOLOGY, 100.0, 500, 5);
        ...
        Inventory.addItem(cpu, 1000);
        Inventory.addItem(ram, 1000);
        Inventory.addItem(ssd, 500);
        Inventory.addItem(screen, 500);
        ...
        pm.addLine(lineC);
        Task Laptop = new Task("add 5 laptop", "Client 1", "Laptop", 5, "26-11-2026 20:00:00");
        Task Phone = new Task("add 8 Phone", "Client 2", "Phone", 5, "26-11-2026 20:00:00");
        Task tablet = new Task("make 5 tablet", "Client 1", "tablet", 5, "26-11-2026 20:00:00");
